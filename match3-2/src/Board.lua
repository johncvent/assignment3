    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do    
            ...
            elseif self.level == 2 then
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(2)))
            elseif self.level == 3 then
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(3)))
            elseif self.level == 4 then
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(4)))
            elseif self.level == 5 then
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(5)))
            else
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(6)))
            end 
        end
