...
function love.draw()
    ...
    --JCV - draws mouse coordinates to the screen
    love.graphics.setColor(255, 255, 255)    
    --if not (mouse.x==nil or mouse.y==nil) then 
    --    love.graphics.print("Mouse Coordinates: " .. mouse.x .. ", " .. mouse.y)
    --end
    --if love.mouse.wasPressed('1') then
        --mousetemp.x, mousetemp.y = love.mouse.wasPressed(1)
        --if not (love.mouse.buttonsPressed[button].x==nil or love.mouse.buttonsPressed[button].y==nil) then 
            --love.graphics.print("Mouse Button: " .. love.mouse.buttonsPressed[button] .. ", " .. love.mouse.buttonsPressed[button].y)
        --end
    --end  
