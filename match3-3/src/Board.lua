...
function Board:initializeTiles()
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do    
            ...
            randshine = math.random(8)
            --JCV - uses level passed in to determine which tiles to include in the board
            if self.level == 1 then
                if randshine == 1 then
                    table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), 1, true))
                else
                    table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), 1, false))     
                end
            elseif self.level == 2 then
                if randshine == 1 then                
                    table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(2),true))
                else           
                    table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(2),false))
                end
            elseif self.level == 3 then
                if randshine == 1 then
                    table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(3), true))
                else
                    table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(3), false))
                end
            elseif self.level == 4 then
                if randshine == 1 then
                    table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(4), true))
                else
                    table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(4), false))
                end
            elseif self.level == 5 then
                if randshine == 1 then
                    table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(5), true))
                else
                    table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(5), false))
                end
            else
                if randshine == 1 then
